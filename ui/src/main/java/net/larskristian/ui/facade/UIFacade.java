...
public class UIFacade {
    ...
    private static final Logger LOG = LogManager.getLogger(UIFacade.class);

    @RequestMapping(value = {UriPaths.UI_HOME, UriPaths.UI_ABOUT, UriPaths.UI_ACCOUNT, UriPaths.UI_LOGIN,
            UriPaths.UI_CV},
